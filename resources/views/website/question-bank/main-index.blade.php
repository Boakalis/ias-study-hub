                                        ...
                                        <div class="col-xl-4 mb-2">
                                            <div class="card card-bordered">
                                                @if(isset($data->image) && !empty($data->image))
                                                  <a href="{{route('getQuestionBankPages',['category' => $data->slug])}}"><img  src="{{asset($data->image)}}" class="card-img-top" /></a>
                                                @else
                                                   <a href="{{route('getQuestionBankPages',['category' => $data->slug])}}"> <img  src="{{asset('images/others/testseries-1.jpg')}}" class="card-img-top" /></a>
                                                @endif
                                                <div class="card-inner card-sm" style="padding:10px; ">
                                                <a class="" href="{{route('getQuestionBankPages',['category' => $data->slug])}}"><h6 class="mt-3 mb-3">{{strtoupper($data->subject)}}</h6></a>
                                                    <div class="clear"></div>
                                                    {{-- <div class="block">
                                                        ...
                                                        <span class="float-right font-weight-bold text-primary">
                                                            <a href="{{route('getQuestionBankPages',['category' => $data->slug])}}" class="btn btn-primary btn-xs">DETAILS</a>
                                                        </span>
                                                    </div> --}}
                                                    <div class="clear"></div>

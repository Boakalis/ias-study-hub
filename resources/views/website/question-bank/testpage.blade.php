...
@section('title',ucwords($test_questions->name).' | '.$test_questions->category->category.' | '.$test_questions->subject->subject)
@section('content')
{{--
   ...
   <div class="container-fluid p-0">
      <div class="nk-content-inner">
         <div class="nk-content-body">
            <div class="nk-block">
               <form action="{{route('resultUpdate',$test_questions->id)}}" method="POST" id="sessionupdate"  enctype="multipart/form-data" >
                  @csrf()
                           ...
                           <div class="nk-block">
                              ...
                              <div class="card-body mt-5 mb-5">
                                 <div class="mh-vh100">
                                    ...
                                    <div class="question-ans quiz-type" data-id="{{ $question->question->id }}" data-simplebar
                                       ...
                                       <div class="">
                                          <div class="test-questions w-100 d-block mb-4">
                                             <h5 class="card-title" >
                                                ...
                                                <div class="float-right">
                                                   <span class="d-inline-block text-center">
                                                   <span id="time" class="min-remainig text-center text-danger">{{$test_questions->duration}}:00</span>
                                                   <br><span class="min-remainig-text">Min Remaining</span>
                                                   </span>
                                                   <div class="d-lg-none d-inline-block">
                                                      <a href="#" class="toggle btn btn-icon btn-trigger mt-n1" data-target="userAside"><em class="icon ni ni-menu-alt-r"></em></a>
                                                   </div>
         ...
         <div class="modal-header">
            <div class="row w-100">
               <div class="col-md-3 col-lg-3 col-sm-3 col-xs-3 ">
                  <img style="" src="{{asset($test_questions->subject['image'])}}" alt="">
               </div>
               <div class="col-md-7 col-lg-7 col-sm-7 col-xs-7 ">
                  <h5 class="mt-2 mb-2" >{{$test_questions->name}}</h5>
                  <span>SUBJECT : {{$test_questions->subject['subject']}}</span><br>

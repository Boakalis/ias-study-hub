...
@endsection
@section('title',@$fullreport->qbtest->name.' - '.@$fullreport->qbtest->category->category.' - '.@$fullreport->qbtest->subject->subject)
@section('content')
                            ...
                            <div class="card-inner">
								<div class="g-3">
									<div>
										<div class="">
                                            <h1>Question Bank</h1>
                                           <h2> {{ ucwords($fullreport->qbtest->name).' - '.ucwords($fullreport->qbtest->category->category).' - '.ucwords($fullreport->qbtest->subject->subject) }}</h2>

                            ...
                            <div class="card-inner">
                                <div class="g-3">
                                    <div class="main-contents">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-lg table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Category Name</th>
                                                        <td>{{$previous_year_subject->name}}</td>
                                                    </tr>
                                        ...
                                        <a href="{{route('testoverview',['series_slug' => $batch->series->slug,'batch_slug' => $batch->slug])}}" class="btn btn-primary btn-sm text-center">Back to Course Page</a>

                                        @elseif($datas->course_id == 3) @if(isset($decrypt_id)>0)

                                        <a href="{{route('previousYearIndex')}}" class="btn btn-primary btn-sm text-center">Back to Course Page</a>
                                        @else

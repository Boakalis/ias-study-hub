                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3">
                                            <div class="card daily-quiz-box">
                                                ...
                                                <a href="{{  route('getDailyQuizList',['year' => $year,'month' => $month->month])  }}"
                                                    class="btn btn-hover color-1 text-uppercase text-center " style="border-radius:0%" > <span
                                                        class="text-center">{{ $month->monthname }}</span> </a>
                                            </div>
                                        </div><!-- .col -->
                                        @endforeach
                                        @endif

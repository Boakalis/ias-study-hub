												...
												<div class="toggle-wrap nk-block-tools-toggle">
													...
													<div class="toggle-expand-content" data-content="pageMenu">
														<ul class="nk-block-tools g-3">
															<li><a href="{{route('mytest')}}" class="btn btn-white btn-dim btn-outline-primary"><em class="icon ni ni-reports"></em><span>Reports</span></a></li>
                                                    ...
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                <h5 class="title"> <a href="{{route('myorder')}}">My Courses</a> </h5>
                                                ...
                                                <div class="card card-bordered ">
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                <h5 class="title"> <a href="{{route('mytest')}}">My Reports</a> </h5>
                                                ...
                                                <div class="card card-bordered ">
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                <h5 class="title"> <a href="{{route('myprofile')}}">My Profile</a> </h5>
                                                ...
                                                <div class="card card-bordered">
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                <h5 class="title"> <a href="{{route('settings')}}">Security Settings</a> </h5>
                                            ...
                                            <div class="card-inner">
                                                <div class="nk-help">
                                                    ...
                                                    <div class="nk-help-action">
                                                        <a href="{{ route('home') }}">Get Support Now</a>
													</div>
												</div>
											</div>
										</div>

                                ...
                                <table class="datatable-init table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td >
                                                @if (($data->course_id )=='1')
                                                <a class="text-uppercase" href="{{route('testoverview',['series_slug'=>$data->batch->series['slug'],'batch_slug'=>$data->batch['slug']])}}" >{{$data->batch['name']}}</a>
                                                @elseif($data->course_id=='2') @if($data->batch_id=="PREMIUM")
                                                <span>UNLIMITED ACCESS TO ALL QB COURSES (FOR 1 YEAR)</span>
                                                @else <a class="text-uppercase" href="{{route('getQuestionBankPages',$data->qbbatch['slug'])}}"><span>{{$data->qbbatch['subject']}}</span>
                                                </a>
                                                @endif @elseif($data->course_id=='3') @if($data->batch_id=="PREMIUM")
                                                <span>PREMIUM PACKAGE</span>
                                                @else
                                                <span> <a class="text-uppercase" href="{{route('previousYearTestIndex',['category'=>$data->pyqbatch['slug']])}}">{{$data->pyqbatch['name']}}</a> </span>
                                                @endif @endif
                                            </td>
                                            <td>
                                                @if ($data->course_id == 1)
                                                <span class="tb-amount text-uppercase ">{{$data->type['name']}}/{{$data->batch->series['name']}}</span>
                                                @else
                                                <span class="tb-amount text-uppercase ">{{$data->type['name']}}</span>
                                                @endif
                                            </td>

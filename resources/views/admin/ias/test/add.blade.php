...
<div class="row">
    <div class="nk-block-head-content col-sm-12 mb-2">
        <h3 class="nk-block-title page-title">
            Test Cloning - Add/Edit Details<a href="{{route('test')}}"
...
<div class="card">
    <div class="card-inner">
        ...
        <form class="mb-5" action="{{ route('clone_test',$datas->id) }}" method="POST" id="test-form"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input {{ $errors->has('status')?'is-invalid':'' }}"

...
<div class="card card-preview">
        ...
        <table class="datatable-init table">
            ...
            <tbody id="tablecontents">
                ...
                <tr class="row1" data-id="{{ $data->id }}" >
                    ...
                    <td class="text-center sort-class">{{ date('d-F-Y',strtotime($data->date)) }}</td>
                    <td class="text-center sort-class">{{$data->duration}}</td>
                    <td class="text-center sort-class">{{$data->time}}</td>
                    ...
                    <td class="text-center sort-class ">
                        <a title="add" class="btn btn-icon btn-xs btn-success" href="{{route('edit_daily_quiz',['id' =>$data->id, 'tab' =>2])}}"><em class="icon ni ni-plus"></em></a>
                        <a title="edit" class="btn btn-icon btn-xs btn-secondary" href="{{route('edit_daily_quiz',['id' =>$data->id, 'tab' =>1])}}"><em class="icon ni ni-edit"></em></a>
    ...
    <div style="float:left;">
        ...
        <div style="float:right;">
            <span id="pagination_click"  >{{$datas->links()}}</span>
...
<script type="text/javascript">
    ...
    $.ajax({
    type: 'get',
    url: "{{url('/admin/daily-quiz/delete-quiz/')}}/" + id,

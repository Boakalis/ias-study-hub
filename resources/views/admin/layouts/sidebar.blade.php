...
<div class="nk-sidebar nk-sidebar-fixed is-dark" data-content="sidebarMenu">
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a href="{{route('admin_dashboard')}}" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" style="margin-left: 20px " src="{{(isset($globalSettings->logo) && !empty($globalSettings->logo)  ? (asset($globalSettings->logo)) : "" )}}" alt="IAS STUDYHUB" />
                {{--<img class="logo-small logo-img logo-img-small " src="{{(isset($globalSettings->logo) && !empty($globalSettings->logo)  ? (asset($globalSettings->logo)) : "" )}}"
                    srcset="{{asset('images/logo-small2x.png ')}}" alt="IAS STUDYHUB" />--}}
                <img class="logo-dark logo-img m-2" src="{{(isset($globalSettings->logo) && !empty($globalSettings->logo)  ? (asset($globalSettings->logo)) : "" )}}" alt="IAS STUDYHUB" />
            </a>
        </div>
                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub  ">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item has-sub {{ Request::is('subject*') ? 'active' : '' }} ">
                                <a href="{{route('subject')}}" class="nk-menu-link">
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('question')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('question-bulk-import')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('series')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('batch')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('test')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('previous_year')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('previous_year_categories')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('previous_year_test')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                                    <span class="nk-menu-text">Test Management </span>
                                </a>
                            </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('question_bank_subject')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                                    <span class="nk-menu-text"> Category Management </span>
                                </a>
                            </li>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('question_bank_categories')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                                    <span class="nk-menu-text"> Sub Category Management </span>
                                </a>
                            </li>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('question_bank_question')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            {{-- <li class="nk-menu-item has-sub">
                                <a href="{{route('daily_quiz_date')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                                    <span class="nk-menu-text"> Date/Month Management </span>
                                </a>
                            </li> --}}
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('daily_quiz')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                                    <span class="nk-menu-text">Test Management </span>
                                </a>
                            </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('user-reports')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('exam-reports')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('subscription-reports')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('setting.general')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                                    <span class="nk-menu-text"> General Setting </span>
                                </a>
                            </li>
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('setting-payment')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                            ...
                            <li class="nk-menu-item has-sub">
                                <a href="{{route('landing-page.index')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                        ...
                        <li class="nk-menu-item has-sub">
                            ...
                            <ul class="nk-menu-sub">
                                <li class="nk-menu-item has-sub">
                                    <a href="{{route('order-analytics')}}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>
                                        <span class="nk-menu-text"> Order Details</span>
                                    </a>
                                </li>
                                <li class="nk-menu-item has-sub">
                                    <a href="{{route('referer')}}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-brick"></em></span>

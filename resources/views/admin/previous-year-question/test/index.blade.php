        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" name="testClone" id="testClone">
                    ...
                    {{-- <div class="md-form">
                        <label class="form-label" for="mark1"> Mark<span  class="required text-danger">*</span></label>
...
<div class="card card-preview">
    <div class="card-inner">
        <form action="{{route('pyq_filter')}}" method="post" >
            @csrf
        ...
        <table class="datatable-init table">
            ...
            <tbody id="tablecontents">
                ...
                <tr class="row1" data-id="{{ $data->id }}"  >
                    <td class="text-center sort-class">{{$key+1}}</td>
                    <td class="text-center sort-class">{{$data->name}}</td>
                    <td class="text-center sort-class">{{ $data->subject->name }}</td>
                    <td class="text-center sort-class">{{ $data->category->category }}</td>
                    {{-- <td class="text-center">{{$data->year}}</td> --}}
                    <td class="text-center sort-class">{{$data->duration}}</td>
                    <td class="text-center sort-class">{{$data->mark}}</td>
                    ...
                    <td class="text-center sort-class">
                        ...
                        <a title="add" class="btn btn-icon btn-xs btn-success" href="{{route('edit_previous_test',['id' => $data['id'],'tab' => 2])}}"><em class="icon ni ni-plus"></em></a>
                        <a title="edit" class="btn btn-icon btn-xs btn-secondary" href="{{route('edit_previous_test',['id' => $data['id'],'tab' => 1])}}"><em class="icon ni ni-edit"></em></a>
...
<script type="text/javascript">
    ...
    $.ajax({
    type: 'POST',
    url: "{{url('/admin/previous-year-management/test/destroy/')}}/" + id,

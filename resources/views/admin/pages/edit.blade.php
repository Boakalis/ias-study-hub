...
<div class="row">
    <div class="nk-block-head-content col-sm-12 mb-2">
        <h3 class="nk-block-title page-title">
            Page - Edit<a href="{{route('page.index')}}" class="btn btn-secondary btn-rounded float-right"> <em class="icon ni ni-chevrons-left"></em> Back</a>
    </h3>
  </div>
</div>
...
<div class="card card-preview ">
  <div class="card-inner">
      ...
      <div class="container-fluid">
        <form class="mb-5" action="{{ route('page.update',$datas['id']) }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}

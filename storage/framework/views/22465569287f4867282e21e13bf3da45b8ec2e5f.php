        ...
        <table class="border-0 background-image" style="border-collapse: collapse; width: 100%;" border="0" rules="rows" cellspacing="0" cellpadding="5">
            <tbody>
                ...
                <tr>
                    ...
                    <td width="98%">
                        <div style="background-image: url(<?php echo e(public_path('images/pdf/1.jpg')); ?>); background-position: top left; background-repeat: no-repeat; background-size: 100%; padding: 0; width:99%; height:99%;">
                            <!-- <p class="username" style="position: absolute; bottom: 0px; right: 10px; font-size: 20px; color: #064d86; text-transform: capitalize;">Name: <?php echo e($fname); ?>&nbsp;<?php echo e($lname); ?></p>
                            <p class="reportdate" style="position: absolute; bottom: 0; left: 0;"><?php echo e($email); ?></p> -->
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td width="98%">
                        <div class="title-txt-blue">
                            <p class="text-uppercase text-center font-24"><?php echo e($course); ?></p>
                        </div>
                    </td>
                    <td width="1%">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td width="98%">
                        <div class="title-txt-blue">
                            <p class="text-uppercase text-center font-24"><?php echo e($series); ?>/<?php echo e($batch); ?></p>
                        </div>
                    </td>
                    <td width="1%">&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td width="1%">&nbsp;</td>
                    <td width="98%">
                        <div class="title-txt-grey-20 font-24">Name: <?php echo e($fname); ?>&nbsp;<?php echo e($lname); ?></div>
                    </td>
                    <td width="1%">&nbsp;</td>
                </tr>
                <tr>
                    <td width="1%">&nbsp;</td>
                    <td width="98%">
                        <div class="title-txt-grey-20 font-24">Email: <?php echo e($email); ?></div>
                    </td>
                    <td width="1%">&nbsp;</td>
                </tr>
                ...
                <?php if(isset($solutions) && !empty($solutions)): ?> <?php $__currentLoopData = $solutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $solution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td width="1%">&nbsp;</td>
                    <td width="98%" align="center" class="text-left title-txt-grey-20">
                        <div class="mb-1">
                            <p class="font-24 text-primary"><b>Question &nbsp;<?php echo e($key+1); ?>:</b></p>

                            <div class="text-questions-details"><?php echo $solution['question']; ?></div>
                            <div class="clear w-100 mb-2"></div>
                            <p><b>Options</b></p>
                            <ul class="list-square">
                                <li><?php echo $solution['option_1']; ?></li>
                                <li><?php echo $solution['option_2']; ?></li>
                                <li><?php echo $solution['option_3']; ?></li>
                                <li><?php echo $solution['option_4']; ?></li>
                            </ul>

                            <div class="clear w-100 mb-2"></div>
                            <p class="mb-1"><b>Your Answer</b></p>
                            <?php echo isset($solution['user_answer'])&&!empty($solution['user_answer'])?$solution['user_answer'] : 'NOT ANSWERED'; ?>

                            <div class="clear w-100 mb-2"></div>
                            <p class="mb-1"><b>Correct Answer</b></p>
                            <?php echo $solution['answers']; ?>

                            <div class="clear w-100 mb-2"></div>
                            <p><b>Explanation</b></p>
                            <div class="question-explanation-details"><?php echo $solution['explanation']; ?></div>
...
</html><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/reportPDF.blade.php ENDPATH**/ ?>
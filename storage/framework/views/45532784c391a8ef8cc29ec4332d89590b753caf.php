...
<script>
    $("#subjectStore").on("submit", function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('create_referer')); ?>",
            type: "post",
            data: $(this).serialize(),
            beforeSend: function () {
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/admin/analytics/management.blade.php ENDPATH**/ ?>
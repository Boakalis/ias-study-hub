        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" name="testStore" id="testStore">
                    ...
                    <br>
                    <div class="md-form">
                        <label class="form-label" for="type">Type<span  class="required text-danger">*</span></label>
                    ...
                    <div class="md-form">
                        ...
                        <input name="mark" id="mark" class="form-control" type="text" />
                    </div>
                    <br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" name="testClone" id="testClone">
                    ...
                    <div class="md-form">
                        <label class="form-label" for="name"> Test Name<span  class="required text-danger">*</span></label>
                        <input name="name" id="test1" class="form-control" type="text" />
                    </div>
                    <br>
                    ...
                    <label for="status1" class="d-block">Status</label>
...
<div class="card card-preview">
    <div class="card-inner">
        <form action="<?php echo e(route('pyq_filter')); ?>" method="post" >
            <?php echo csrf_field(); ?>
        ...
        <table class="datatable-init table">
            ...
            <tbody id="tablecontents">
                ...
                <tr class="row1" data-id="<?php echo e($data->id); ?>"  >
                    ...
                    <td class="text-center sort-class"><?php echo e($data->subject->name); ?></td>
                    ...
                    <td class="text-center sort-class">
                        ...
                        <?php else: ?>
                        <a class="btn btn-xs btn-dim btn-outline-success">Paid</a>
                        <?php endif; ?>
                    </td>
                    <td class="text-center sort-class">
                        ...
                        <a title="add" class="btn btn-icon btn-xs btn-success" href="<?php echo e(route('edit_previous_test',['id' => $data['id'],'tab' => 2])); ?>"><em class="icon ni ni-plus"></em></a>
                        <a title="edit" class="btn btn-icon btn-xs btn-secondary" href="<?php echo e(route('edit_previous_test',['id' => $data['id'],'tab' => 1])); ?>"><em class="icon ni ni-edit"></em></a>
    ...
    $(function () {
        ...
        function sendOrderToServer() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo e(route('pyq-order-change')); ?>",
                data: {
                    order: order,
                    _token: token
                },
...
<script>
    $("#testClone").on("submit", function (e) {
        ...
        let id = $('#id').val();
        $.ajax({
            url:  "/admin/pyq/test/store-clone/"+id ,
            type: "post",
            data: $(this).serialize(),
...
<script>
    $("#testStore").on("submit", function (e) {
        e.preventDefault();
        $.ajax({
            url: "/admin/previous-year-management/test/store",
            type: "post",
            data: $(this).serialize(),
...
<script type="text/javascript">
    ...
    $.ajax({
    type: 'POST',
    url: "<?php echo e(url('/admin/previous-year-management/test/destroy/')); ?>/" + id,
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/admin/previous-year-question/test/index.blade.php ENDPATH**/ ?>
...
<div class="row">
    <div class="nk-block-head-content col-sm-12 mb-2">
        <h3 class="nk-block-title page-title">
            Test Management - Add Test<a href="<?php echo e(route('test')); ?>" class="btn btn-secondary btn-rounded float-right"> <em
...
<div class="card">
    <div class="card-inner">
        ...
        <form class="mb-5" action="<?php echo e(route('store_test')); ?>" method="POST" id="test-form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-9">
                        <div class="form-control-wrap">
                            <select class="form-select " data-search="on" name="batch_id" id="batch">
                                ...
                                <option value="<?php echo e($value['id']); ?>"><?php echo e($value->series['name']); ?>--<?php echo e($value['name']); ?></option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/admin/ias/test/create.blade.php ENDPATH**/ ?>
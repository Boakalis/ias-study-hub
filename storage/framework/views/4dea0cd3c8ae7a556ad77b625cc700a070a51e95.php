                                ...
                                <table class="datatable-init table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td width=50% >
                                               <?php echo e($data->test->name); ?>

                                               <span class="badge badge-dot badge-gray d-flex">BATCH NAME:<?php echo e($data->batch->name); ?></span>
                                               <span class="badge badge-dot badge-gray d-flex">SERIES NAME:<?php echo e($data['batch']['series']['name']); ?></span>
                                            </td>
                                            
                                            <td width=20% >
                                                <span class="badge badge-dot badge-gray d-flex"><?php echo e(date('d-F-Y',strtotime($data->date))); ?></span>
                                            ...
                                            <td width=20%>
                                                ...
                                                data-attr="<?php echo e(route('show_report',$data->id)); ?>" title="show">
                                                <em class="fas fa-eye "></em>&nbsp;View</button>

                                                
                                                 <form action="<?php echo e(route('generatePDF',['parameter' => Crypt::encrypt($data->id) , 'encrypted_user_id' =>Crypt::encrypt(Auth::user()->id)])); ?>" method="get"  class="d-inline-block">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('website.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/website/Users/mytest.blade.php ENDPATH**/ ?>
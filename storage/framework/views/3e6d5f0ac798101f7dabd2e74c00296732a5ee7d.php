...
<?php $__env->startSection('title', $test_questions->name.'|'.$test_questions->batch->name.'|'.$test_questions->batch->series->name); ?>
    ...
    <div class="container-fluid p-0">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <div class="nk-block">
                 <form action="<?php echo e(route('sessionupdate',$test_questions->id)); ?>" method="POST" id="sessionupdate"  enctype="multipart/form-data" >
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="card-inner card-inner-lg p-0">
                                ...
                                <div class="nk-block">
                                    ...
                                    <div class="card-header bg-white border-bottom position-fixed-top">
                                        <h5 class="text-primary text-uppercase"><span class=" current-exam-title"><?php echo e($test_questions->name); ?></span>
                                            ...
                                            <span class="float-right min-remainig text-center  text-danger"><i class="far fa-clock"></i>
                                                <span id="time" class="" data-time="<?php echo e($test_questions->duration); ?>" >00:00
                                                </span>
                                            </span>
                                    ...
                                    <div class="card-body mt-5">
                                        ...
                                        <div class="question-ans" data-id="<?php echo e($question->question->id); ?>" data-simplebar
                                            ...
                                            <div class="">
                                                <div class="test-questions w-100 d-block mb-4">
                                                    <h6 class="card-title" >Question <?php echo e($question_key); ?>:
                                                    ...
                                                    <div class="custom-control custom-radio mr-3 p-0 text-left">
                                                        <input type="radio"  data-option="1" id="questans-<?php echo e($question->question->id); ?>-1" name="questionans[<?php echo e($question->question->id); ?>]" class="custom-control-input option-answer" value="1" data-question-id="<?php echo e($question_key); ?>">
                                                        <label class="custom-control-label w-100" for="questans-<?php echo e($question->question->id); ?>-1"><?php echo $question->question->option_1; ?></label>
                                                    </div>
                                                    <div class="custom-control custom-radio mr-3 p-0 text-left">
                                                        <input type="radio"  data-option="2" id="questans-<?php echo e($question->question->id); ?>-2" name="questionans[<?php echo e($question->question->id); ?>]" class="custom-control-input option-answer" value="2" data-question-id="<?php echo e($question_key); ?>">
                                                        <label class="custom-control-label w-100" for="questans-<?php echo e($question->question->id); ?>-2"><?php echo $question->question->option_2; ?></label>
                                                    </div>
                                                    <div class="custom-control custom-radio mr-3 p-0 text-left">
                                                        <input type="radio"  data-option="3" id="questans-<?php echo e($question->question->id); ?>-3" name="questionans[<?php echo e($question->question->id); ?>]" class="custom-control-input option-answer" value="3" data-question-id="<?php echo e($question_key); ?>">
                                                        <label class="custom-control-label w-100" for="questans-<?php echo e($question->question->id); ?>-3"><?php echo $question->question->option_3; ?></label>
                                                    </div>
                                                    <div class="custom-control custom-radio mr-3 p-0 text-left">
                                                        <input type="radio" data-option="4" id="questans-<?php echo e($question->question->id); ?>-4" name="questionans[<?php echo e($question->question->id); ?>]" class="custom-control-input option-answer" value="4" data-question-id="<?php echo e($question_key); ?>">
                                                        <label class="custom-control-label w-100" for="questans-<?php echo e($question->question->id); ?>-4"><?php echo $question->question->option_4; ?></label>
                                                    </div>
                                                </div>
                                                <div class="clear"></div>
                                            </div>
                                        ...
                                        <input type="hidden" name="series_name" value="<?php echo e($test_questions->batch->series['name']); ?>">
                                        <input type="hidden" name="batch_name" value="<?php echo e($test_questions->batch['name']); ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="test-answers-list mb-5 ">
                                                <ul>
                                                    ...
                                                    <li><span class=" btn btn-md <?php echo e(($i ==1)?'btn-secondary':'btn-outline-secondary'); ?> question custom-click " title="Question" data-qno="<?php echo e($i); ?>" id="question-button-<?php echo e($i); ?>"><?php echo e($i); ?></span></li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md text-center">
                ...
                <div class="row">
                    <div class="col-md-6"> <h6>Total Question : <?php echo e($question_count); ?> </h6></div>
            ...
            <div class="modal-header">
                <div class="row w-100">
                    <!-- <div class="col-md-3 col-lg-3 col-sm-3 col-xs-3 ">
                        <img style="width: 212px;height:92px;" src="<?php echo e(asset($test_questions->batch->series['image'])); ?>" alt="">
                    </div> -->
                    <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9 ">
                        <h5 class="mt-2 mb-2 text-primary" ><?php echo e($test_questions->name); ?></h5>
                        <span>SERIES : <?php echo e($test_questions->batch->series['name']); ?></span><br>
                        <span>BATCH : <?php echo e($test_questions->batch['name']); ?></span>
                    </div>
                            ...
                            <table class="table table-bordered table-md table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo e(@$test_questions->negativemark); ?></th>
                                    </tr>
                                </tbody>
                            </table>
...
<?php echo $__env->make('website.TestLayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/website/Users/IAS/Test/IAS-testseries.blade.php ENDPATH**/ ?>
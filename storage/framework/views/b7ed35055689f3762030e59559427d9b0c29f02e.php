...
<div class="row">
    <div class="nk-block-head-content col-sm-12 mb-2">
        <h3 class="nk-block-title page-title text-uppercase ">
            Batch Management - Edit Batch<a href="<?php echo e(route('batch')); ?>" class="btn btn-secondary btn-rounded float-right"> <em class="icon ni ni-chevrons-left"></em> Back</a>
        </h3>
    </div>
</div>
...
<div class="card">
    <div class="card-inner">
        <form class="mb-5" action="<?php echo e(route('update_batch', $datas['id'])); ?>" method="POST" id="edit-form" enctype="multipart/form-data">
            ...
            <div class="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="form-control-wrap">
                            <input type="text" name="name" value="<?php echo e($datas['name']); ?>" class="form-control" placeholder="Enter Name" required oninvalid="this.setCustomValidity('Please Enter Batch Name')" oninput="setCustomValidity('')" />
                    ...
                    <div class="col-md-9">
                        <div class="form-control-wrap">
                            <select class="form-select" name="series_id" data-search="on">
                                ...
                                <?php $__currentLoopData = $series; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <option value="<?php echo e($value['id']); ?>" <?php echo e(( $datas->series['id'] == $value['id']) ? 'selected' : ''); ?>><?php echo e($value->name); ?></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="form-control-wrap input-group mb-3">
                            <input type="text" value="<?php echo e($datas['discount']); ?>" class="form-control" placeholder="Enter Discount" id="discount" name="discount" required
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="form-control-wrap">
                            <textarea name="description" id="description" placeholder="Enter your Description" class="form-control tinymce-editor" cols="30" rows="10"><?php echo e($datas['description']); ?></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="form-control-wrap">
                            <input type="text" value="<?php echo e($datas['slug']); ?>" class="form-control" placeholder="Enter Slug" id="price" name="slug" />
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/admin/ias/batch/edit.blade.php ENDPATH**/ ?>
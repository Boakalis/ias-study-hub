...
<div class="row">
    <div class="nk-block-head-content col-sm-12 mb-2">
        <h3 class="nk-block-title page-title">
            Question Management <a href="<?php echo e(route('question')); ?>" class="btn btn-secondary btn-rounded float-right"> <em class="icon ni ni-chevrons-left"></em> Back</a>
        </h3>
    </div>
</div>
                ...
                <form action="<?php echo e(route('import')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <span class="text-danger"><?php echo e($errors->first('file')); ?></span><br />
                            <?php endif; ?>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <!-- <a class="btn btn-warning" href="<?php echo e(route('export')); ?>">Export Question Data</a> -->
                        </div>
                    </div>
                </form>
            </div><br>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/admin/question/bulk-import.blade.php ENDPATH**/ ?>
        ...
        <nav class="navbar site-navbar">
            ...
            <div class="brand-logo">
                <a href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset(@$globalSettings->logo)); ?>" alt="" class="light-version-logo logo-style" />
                ...
                <nav class="menu-block" id="append-menu-header">
                    ...
                    <ul class="site-menu-main">
                        ...
                        <li class="nav-item nav-item-has-children">
                            <a href="<?php echo e(url('/')); ?>" class="nav-link-item drop-trigger">Home </a>
                        </li>
                        <li class="nav-item nav-item-has-children">
                            <a href="<?php echo e(route('test-series')); ?>" class="nav-link-item drop-trigger">IAS Test Series </a>
                        </li>
                        <li class="nav-item nav-item-has-children">
                            <a href="<?php echo e(route('previousYearIndex')); ?>" class="nav-link-item drop-trigger">Previous Year Management</a>
                        </li>
                         <li class="nav-item nav-item-has-children">
                            ...
                            <ul class="sub-menu" id="submenu-1">
                                ...
                                <li class="sub-menu--item">
                                    <a href="<?php echo e(route('getQuestionBankPages',$question_bank->slug)); ?>"><?php echo e(ucwords($question_bank->subject)); ?></a>
                                </li>
            ...
            <div class="header-btns ms-auto ms-lg-0 d-none d-sm-flex align-items-center">
                ...
                <div class="user-avatar sm">
                    ...
                    <a href="<?php echo e(route('myprofile')); ?>">
                        <img src="<?php echo e(asset(Auth::user()->image)); ?>" alt="My Profile" style="width: 32px;" class="rounded-circle" />
                        <span></span>
                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('myprofile')); ?>">
                        <img src="<?php echo e(asset('images/website/user-photos/default-image.png')); ?>" style="width: 32px;" alt="My Profile" class="rounded-circle" />
                    </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="header-btns ms-auto ms-lg-0 d-sm-none align-items-center">
                <?php if(auth()->guard()->guest()): ?>
                <a class="h-45" href="<?php echo e(route('login')); ?>">
                    <img src="<?php echo e(asset('images/website/user-photos/default-image.png')); ?>" style="width: 32px;" alt="My Profile" class="rounded-circle" />
                </a>
                <?php endif; ?> <?php if(auth()->guard()->check()): ?> <?php if(Auth::user()->image != null): ?>
                <a href="<?php echo e(route('myprofile')); ?>">
                    <img src="<?php echo e(asset(Auth::user()->image)); ?>" alt="My Profile" style="width: 32px;" class="rounded-circle" />
                </a>
                <?php else: ?>
...
<div class="footer-navigation d-block d-md-none w-100">
    ...
    <div class="footer-navigation__container ng-scope" ng-if="!tbHeader.stuObj.isLoggedIn">
        <a href="<?php echo e(url('/')); ?>" target="_self" class="footer-navigation__item">
        ...
        <a href="<?php echo e(route('test-series')); ?>" target="_self" class="footer-navigation__item">
        ...
        <a href="<?php echo e(route('previousYearIndex')); ?>" target="_self" class="footer-navigation__item">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" class="svg-f-green" viewBox="0 0 24 24">
                <g fill="">
                    <path
        ...
        <a href="<?php echo e(route('getQuestionBankPages')); ?>" target="_self" class="footer-navigation__item">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" class="svg-f-green" viewBox="0 0 24 26">
                <g>
                    <path
                        d="M4.817 2.434v.74c0 1.024.83 1.853 1.853 1.853h5.188c1.023 0 1.852-.83 1.852-1.852v-.741h2.965c.973 0 1.773.753 1.847 1.708l.006.144v16.996c0 .973-.754 1.773-1.709 1.847l-.144.006H1.853c-.973 0-1.773-.754-1.847-1.709L0 21.282V4.286c0-.973.754-1.773 1.708-1.847l.145-.005h2.964zm7.279-.488c.17 0 .31.139.31.31v.35c0 .857-.695 1.551-1.551 1.551H7.673c-.857 0-1.551-.694-1.551-1.55v-.35c0-.172.139-.311.31-.311z"
...
<!-- Mobile Bottom Menu -->
<?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/website/website-layout/header.blade.php ENDPATH**/ ?>
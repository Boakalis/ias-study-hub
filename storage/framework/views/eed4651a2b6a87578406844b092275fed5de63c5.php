                                                ...
                                                <div class="between-center flex-wrap g-3">
                                                    ...
                                                    <div class="nk-block-actions flex-shrink-sm-0">
                                                        <ul class="align-center flex-wrap flex-sm-nowrap gx-3 gy-2">
                                                            ...
                                                            <?php if(isset(Auth::user()->password_status) && !empty(Auth::user()->password_status)): ?>
                                                            <li>
                                                                <em class="text-soft text-date fs-12px">Last changed: <span><?php echo e(isset(Auth::user()->password_status) && !empty(Auth::user()->password_status) ? date('d-F-Y', strtotime(Auth::user()->password_status)) : ""); ?></span></em>
                                                            </li>
                                    ...
                                    <div class="card-inner">
                                        <div class="user-card">
                                            <div class="user-avatar">
                                                ...
                                                <img src="<?php echo e(asset(asset(Auth::user()->image))); ?>" alt="User">
                                                    <?php else: ?>
                                            ...
                                            <div class="user-info">
                                                ...
                                                <span class="lead-text"> <?php echo e(Str::ucfirst(Auth::user()->fname)); ?>&nbsp;<?php echo e(Auth::user()->lname); ?></span>
                                                <?php else: ?>
                                                <span class="lead-text"> <?php echo e(Str::ucfirst(Auth::user()->fname)); ?></span>
                                                <?php endif; ?>
...
<div class="modal-dialog modal-sm cascading-modal modal-avatar" role="document"  >
    ...
    <div class="modal-header" style="justify-content: center" >
            <img style="height:100px;width:100px;"  src="<?php echo e(isset(Auth::user()->image) && !empty(Auth::user()->image) ? asset(Auth::user()->image) : asset('images/website/user-photos/default-image.png')); ?>" class=" text-center rounded-circle img-responsive">
        </div>
        <!--Body-->
        <div class="modal-body text-center mb-1">

            <h5 class="mt-1 mb-2">Hi , <?php echo e(Auth::user()->fname); ?></h5>
...
<?php echo $__env->make('website.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/website/Users/settings.blade.php ENDPATH**/ ?>
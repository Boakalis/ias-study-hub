...
<?php $__env->startSection('title', strtoupper($test_questions->name).' | '.$test_questions->category->category.' | '.$test_questions->subject->name); ?>
   ...
   <div class="container-fluid p-0">
      <div class="nk-content-inner">
         <div class="nk-content-body">
            <div class="nk-block">
               <form action="<?php echo e(route('previousResultUpdate',$test_questions->id)); ?>" method="POST" id="sessionupdate"  enctype="multipart/form-data" >
                  <?php echo csrf_field(); ?>
                                    ...
                                    <div class="question-ans" data-id="<?php echo e($question->question->id); ?>" data-simplebar
                                       ...
                                       <div class="">
                                          <div class="test-questions w-100 d-block mb-4">
                                             <h5 class="card-title" >Question <?php echo e($question_key); ?>:</h5>
   ...
   <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <div class="row w-100">
               <div class="col-md-3 col-lg-3 col-sm-3 col-xs-3 ">
                  <img src="<?php echo e(asset($test_questions->subject->image)); ?>" alt="<?php echo e($test_questions->name); ?>" >
               </div>
               <div class="col-md-7 col-lg-7 col-sm-7 col-xs-7 ">
                  <h5 class="mt-2 mb-2" ><?php echo e($test_questions->name); ?></h5>
                  <span>SUBJECT : <?php echo e($test_questions->subject['name']); ?></span><br>
         ...
         <div class="modal-footer" style="justify-content: center" >
            <a href="<?php echo e(url()->previous()); ?>" class=" text-dark btn btn-success btn-lg " data-dismiss="modal" aria-label="Close">
            Proceed
            </a>
         </div>
      </div>
...
<?php echo $__env->make('website.TestLayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/614552.cloudwaysapps.com/seeurhhvyv/public_html/resources/views/website/previous-year-question/testpage.blade.php ENDPATH**/ ?>
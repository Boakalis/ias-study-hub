...
class LandingPagesController extends Controller
{
    ...
    {
        $datas = LandingPage::get();
        return view('admin.landing-pages.index',compact('datas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->validate(request(),[
            'slug' => 'required|unique:pages,slug|unique:landing_pages,slug',
        ]);
    ...
    {
        $datas = LandingPage::find($id);
        return view('admin.landing-pages.edit',compact('datas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate(request(),[
            'slug' => 'required|unique:pages,slug|unique:landing_pages,slug,'.$id,
        ]);
        ...
        LandingPage::where('id',$id)->update($datas);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('page.index')->with('success','Landing Page Deleted Successfully');
    }
}
